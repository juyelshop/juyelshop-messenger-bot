...
const ACCESS_TOKEN = "";
...
// মেসেজ চেক করে রিপ্লে রিটার্ন করা
function checkDeliveryQuestion(message) {
  const msg = message.trim().toLowerCase();
  for (let question of deliveryQuestions) {
    if (msg === question.toLowerCase()) {
